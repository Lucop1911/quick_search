use std::path::Path;
use crate::utils::{helpers::helpers::{get_terminal_editor, is_command_available}, settings_manager::SettingsManager, utils::{ActionType, SearchResult}};
...
pub fn open_path_intelligently(path: &Path) {
